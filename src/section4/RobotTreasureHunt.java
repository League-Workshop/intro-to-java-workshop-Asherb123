...
public class RobotTreasureHunt implements KeyEventDispatcher{
	...
	private void spaceBarWasPressed() {
		...
		int robottYLocation = mini.getY();
		
		// 6. Print the robotXLocation and robotYLocation variables to the console 
		System.out.println(robotXLocation);
		System.out.println(robottYLocation);
		// 7. If robot is at same location as the little girl
		if (robotXLocation==720&&robottYLocation==410) {
			JOptionPane.showMessageDialog(null, "Find the scull");
		}
		...
		if (robotXLocation==250&&robottYLocation==120) {
		treasureFound();	
